...
import com.utsavmobileapp.utsavapp.fetch.FetchTopPopular;
...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        popular = (LinearLayout) view.findViewById(R.id.popular);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && !_areLecturesLoaded) {
            ...
            new FetchTopPopular(mContext, popular, llc.readLat(), llc.readLng()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
