 ...
 */
public class StorySlideshowFragment extends DialogFragment {
    ...
    public static StorySlideshowFragment newInstance() {
        return new StorySlideshowFragment();
    }
            ...
            AsyncTask.execute(new Runnable() {
                                  ...
                                  public void run() {
                                      ...
                                      for (int i = 0; i < images.size(); i++) {
                                          ...
                                          stories.get(storyId).getOtherImgcmt().set(i, String.valueOf(images.get(i).getTotalcomment()));
