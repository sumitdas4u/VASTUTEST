...
/**
 * Created by Bibaswann on 08-05-2016.
 */
            ...
            if (isGPSEnabled) {
                ...
                if (location == null) {
                    if (ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        Toast.makeText(mContext, "Please provide access to location", Toast.LENGTH_LONG).show();
                        location = new Location("");//provider name is unecessary
                        location.setLatitude(22.5667);
                        location.setLongitude(88.3667);
                        return location;
                    }
