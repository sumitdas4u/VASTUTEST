...
/**
 * Created by Bibaswann on 09-05-2016.
 */
...
import com.utsavmobileapp.utsavapp.parser.ParsePlaceDetailsJSON;
...
public class PlaceProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.utsavmobileapp.utsavapp.service.PlaceProvider";
    ...
    String mKey = "key=AIzaSyBh1OKV-obMOKCVdO5nQqiXB5yqU5wnB4s";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        ParsePlaceJSON parser = new ParsePlaceJSON();
        ParsePlaceDetailsJSON detailsParser = new ParsePlaceDetailsJSON();
        ...
        switch (mUriMatcher.match(uri)) {
            case SEARCH:
                ...
                parser = new ParsePlaceJSON();

                // Create a parser object to parse place details in JSON format
                detailsParser = new ParsePlaceDetailsJSON();
